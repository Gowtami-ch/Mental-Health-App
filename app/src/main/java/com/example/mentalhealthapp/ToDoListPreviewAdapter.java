...
public class ToDoListPreviewAdapter extends RecyclerView.Adapter<ToDoListPreviewAdapter.viewHolder> {
    ...
    ArrayList<JournalEntry> toDoListEntries= new ArrayList<>();

    public ToDoListPreviewAdapter(ArrayList<JournalEntry> toDoListEntries) {
        this.toDoListEntries =toDoListEntries;
    }

    public void setToDoListEntries(ArrayList<JournalEntry> toDoListEntries) {
        this.toDoListEntries =toDoListEntries;
    ...
    public void onBindViewHolder(@NonNull ToDoListPreviewAdapter.viewHolder holder, int position) {
        ...
        holder.description.setText(toDoListEntries.get(position).getContent());
